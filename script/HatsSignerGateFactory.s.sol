...
contract DeployHatsSignerGateFactory is Script {
    ...
    string public version = "HSG Beta 4";
    ...
    // forge verify-contract --chain-id 100 --num-of-optimizations 1000000 --watch --compiler-version v0.8.16+commit.07a7930e 0x9b50AB91b3ffBcdd5d5Ed49eD70bf299434C955C src/HatsSignerGate.sol:HatsSignerGate $ETHERSCAN_KEY
}
