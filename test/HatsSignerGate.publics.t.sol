...
contract CheckTransaction is WithHSGHarnessInstanceTest {
  ...
  function test_happy_checkTransaction_callToNonSafe() public {
...
contract CheckAfterExecution is WithHSGInstanceTest {
  function test_happy_checkAfterExecution() public { }

  function test_revert_notCalledFromSafe() public { }

  function test_revert_cannotDisableThisGuard() public { }

  function test_revert_cannotChangeThreshold() public { }

  function test_revert_cannotChangeOwners() public { }

  function test_revert_cannotChangeFallbackHandler() public { }

  function test_revert_cannotAddModules() public { }

  function test_revert_cannotRemoveThisModule() public { }

  function test_revert_guardEntriesUnderflow() public { }
}
